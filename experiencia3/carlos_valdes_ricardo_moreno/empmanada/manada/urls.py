...
from .views import index, quienSomos, contacto, galeria, registrarse, from_modcomida, form_comida, mostrar, form_del_comida, form_cliente, form_modcliente, form_del_cliente
